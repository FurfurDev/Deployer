...
public class MakefileFunctionalTest
{
    @TempDir
    File projectDir;
    ...
    {
        return new File(getIndexDirectory(), "Makefile.toml");
    }
    ...
    {
        return new File(getDeployDirectory(), "content.txt");
    }
