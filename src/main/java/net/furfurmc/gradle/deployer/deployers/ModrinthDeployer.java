...
{
    private ModrinthWebClient webClient = new ModrinthWebClient();

    public ModrinthDeployer(File cacheDirectory)
    {
        super(ModrinthEntity.class, cacheDirectory);
    }
    ...
    public void deploy(AbstractEntity entity)
    {
        ...
        {
            // set deployEntity
            var deployEntity = (ModrinthEntity) entity;
            ...
            // make deploy hash
            var deployHash  = webClient.getVersionFileHash(deployEntity.versionId, deployEntity.versionFile);
            ...
            // deploy
            var webResponse = webClient.downloadVersionFile(deployEntity.versionId, deployEntity.versionFile);
        ...
        {
            throw new RuntimeException("Fail deploy ModrinthEntity.", exception);
        }
    }
}
